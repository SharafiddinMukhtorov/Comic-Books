    ...
    public static async Task SeedAsync(ApplicationDbContext context, ILogger logger)
    {
        try
        {
            ...
            if (!await context.Comics.AnyAsync())
            {
                ...
                // AniList CDN — allows hotlinking, no CORS issues
                var comicsData = new[]
                {
                    new {
                        Title   = "Solo Leveling",
                        Author  = "Chugong", Artist = "DUBU",
                        Desc    = "Sung Jinwoo, the world's weakest hunter, discovers a mysterious quest log after nearly dying in a double dungeon. He alone can see these quests — and through them, grows without limit into the world's most powerful hunter.",
                        ...
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx87587-6IORkQbMkVsO.jpg",
                    ...
                    new {
                        ...
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx112638-gHkaTuPJxdBz.jpg",
                    ...
                    new {
                        ...
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx89719-sdBVWsRtkFmZ.jpg",
                    ...
                    new {
                        ...
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx115573-UMjjO8ONmO5j.jpg",
                    ...
                    new {
                        ...
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx108849-j8wdqbQO91kd.jpg",
                    ...
                    new {
                        ...
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx158849-GePeUKlCOQmm.jpg",
                        Genres  = new[]{ action.Id, fantasy.Id }
                    },
                    new {
                        Title   = "Childhood Friend of the Zenith",
                        Author  = "Chaeyun", Artist = "Zoontar",
                        Desc    = "A regression manhwa where a man returns to his childhood armed with the knowledge of a lifetime — to protect those he failed and change his tragic fate.",
                        Rating  = 9.2, Views = 3400000,
                        Status  = ComicStatus.Ongoing,   Type = ComicType.Manhwa,
                        Featured= true,  Popular = true,  Slug = "childhood-friend-zenith",     Year = 2022,
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx130249-TFYsqPcBXMKo.jpg",
                    ...
                    new {
                        ...
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx131590-1YSMXrqBPCrS.jpg",
                        Genres  = new[]{ action.Id, fantasy.Id }
                    },
                    new {
                        Title   = "Infinite Mage",
                        Author  = "Juugin", Artist = "Lek",
                        Desc    = "Shirone, a commoner who loves magic, is given a chance to attend a mage academy. His unique insight into the infinite challenges every magical convention known to man.",
                        Rating  = 9.1, Views = 2500000,
                        Status  = ComicStatus.Ongoing,   Type = ComicType.Manhwa,
                        Featured= true,  Popular = true,  Slug = "infinite-mage",               Year = 2021,
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx130609-ILYu4NJpZQH5.jpg",
                        Genres  = new[]{ fantasy.Id, action.Id, adventure.Id }
                    },
                    new {
                        ...
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx158290-bUrTTXMtIANW.jpg",
                    ...
                    new {
                        ...
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx145948-4uUHClJyK6w8.jpg",
                        Genres  = new[]{ martialArts.Id, murim.Id, action.Id }
                    },
                    new {
                        Title   = "Reborn as a Heavenly Demon",
                        Author  = "Various", Artist = "Various",
                        Desc    = "A man reborn into the body of a demonic cult's young master must conceal his identity while navigating treacherous murim politics to climb to the very top.",
                        Rating  = 9.0, Views = 2800000,
                        Status  = ComicStatus.Ongoing,   Type = ComicType.Manhwa,
                        Featured= true,  Popular = false, Slug = "reborn-heavenly-demon",       Year = 2022,
                        Cover   = "https://s4.anilist.co/file/anilistcdn/media/manga/cover/large/bx128881-lDfBpQ1LMVyO.jpg",
                ...
                await context.SaveChangesAsync();
                logger.LogInformation("Seeded {C} comics with AniList covers", comics.Count);
            }
        }
        catch (Exception ex)
        {
